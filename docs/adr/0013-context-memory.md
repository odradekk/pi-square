...
Superseded by [ADR-0018 — In-task Context Memory through request projection](./0018-context-memory-request-projection.md)
...
implements in-task append recording and next-request projection. ADR-0018
