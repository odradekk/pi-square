...
- If it doesn't exist, confirm with the user before creating it — don't create it unasked.

`AGENTS.md` is frequently a hand-maintained contract document. Treat everything outside the `## Agent skills` block as untouchable.
